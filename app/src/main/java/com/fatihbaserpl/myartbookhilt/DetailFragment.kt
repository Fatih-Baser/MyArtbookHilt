...
import com.fatihbaserpl.myartbookhilt.databinding.FragmentartdetailsBinding
...
) : Fragment(R.layout.fragmentartdetails) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.artImageView.setOnClickListener {
            findNavController().navigate(
                DetailFragmentDirections.actionDetailFragmentToMageFragment()
            )
        }
